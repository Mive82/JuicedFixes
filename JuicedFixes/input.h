...
enum class RaceButtons : int
{
	...
	GearUp = 7,
	Skip = 8,
	Driver1Up = 9, // Driver 1 UP
	Driver2Up = 10, // Driver 2 UP
	Driver1Down = 11, // Driver 1 DOWN
	Driver2Down = 12, // Driver 2 DOWN
	Driver3Up = 13, // Driver 3 UP
	Driver3Down = 14, // Driver 3 DOWN
	Race15 = 15,
	Handbrake = 16,
	Reverse = 17
};
